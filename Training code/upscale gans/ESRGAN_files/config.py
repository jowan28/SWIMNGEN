...
csv_log = (
    "/home2/vcqf59/Classified/masters-project/upscaler/ESRGAN_folder/final_2_times"
)
post_train_csv_log = (
    "/home2/vcqf59/Classified/masters-project/upscaler/ESRGAN_folder/post_final_2_times"
)
...
GPU_PRETRAINED_GENERATOR_MODEL = os.path.join(
    BASE_OUTPUT_PATH, "models", "big_attention_pretrained_generator"
)
GPU_GENERATOR_MODEL = os.path.join(
    BASE_OUTPUT_PATH, "models", "big_attention_generator"
)
