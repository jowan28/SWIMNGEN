...
class ESRGANTraining(Model):
    ...
    def train_step(self, images):
        ...
        # gradients computed
        self.dOptimizer.apply_gradients(zip(grads, self.discriminator.trainable_variables))
        ...
        return {"dLoss": dLoss, "gTotalLoss": gTotalLoss, "gLoss": gLoss, "percLoss": percLoss, "pixelLoss": pixelLoss}