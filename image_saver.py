...
SWIMNGEN = tf.keras.models.load_model(
    "/home2/vcqf59/Swimseg_2/SWIMSEG_PLUS/final_model/"
)
save_images(SWIMNGEN, 100, "/home2/vcqf59/Swimseg_2/SWIMSEG_PLUS/Swimseg_aug/")
save_images(
    SWIMNGEN, 100, "/home2/vcqf59/Swimseg_2/SWIMSEG_PLUS/Swinseg_aug/", m_or_n="swinseg"
)
